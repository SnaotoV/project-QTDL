...
<div></div>
        <?php if(isset($_SESSION['user_type'])&&$_SESSION['user_type']==='admin'||isset($_SESSION['user_type'])&&$_SESSION['user_type']==='teacher'):?>
            <a class="my-3 offset-10 btn btn-success" href="<?=BASE_URL_PATH . 'addCauHoi.php?maDT=' . $DeThi->maDT ?>">Thêm câu hỏi</a>
        <?php endif?> 
    <?php
    $demCauHoi = 1;
    ...
    <?php else:?>
        <div class="my-3 offset-3">Đề Thi chưa có câu hỏi 
        <?php if(isset($_SESSION['user_type'])&&$_SESSION['user_type']==='admin'||isset($_SESSION['user_type'])&&$_SESSION['user_type']==='teacher'):?>
            <a class="offset-3 btn btn-success" href="<?=BASE_URL_PATH . 'addCauHoi.php?maDT=' . $DeThi->maDT ?>">Thêm câu hỏi</a>
        <?php else:?>
